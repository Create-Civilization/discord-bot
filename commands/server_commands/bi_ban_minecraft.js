...
module.exports = {
    ...
    async execute(client,interaction) {
        ...
        try{
            ...
            const banRelease = Math.floor(Date.now() / 1000) + (time);
            ...
            log({
                embeds: [await createLogEmbed(
                    ...
                    `Banned user: \"${username}\" | Banned Until: ${new Date(banRelease * 1000).toLocaleString('en-US', {timeZoneName: 'short'})} | Reason: ${reason}`,
                    client
                )]
            }, client)
